...
import com.generation.projetolojagamer.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	@GetMapping("/departamento/{departamento}")
	 public ResponseEntity<List<Categoria>> GetByTitulo(@PathVariable String departamento){
